...
worksheet.write_merge(0, 0, 1, 6, 'subread识别后',style)
...
#part2
worksheet.write_merge(8, 8, 1, 6, 'subread筛选后',style)
...
worksheet.write_merge(16, 16, 1, 6, 'Consensus构建后',style)
...
#part4
worksheet.write_merge(24, 24, 1, 9, '原始subread统计',style)
...
worksheet.write(25,9, "Overall",style)
...
# 绘制柱状图
g = sns.barplot(x=congnizaton1_read_type, y=congnizaton1_read_ratio,ax=ax1,width=0.8,palette=["lightgray","silver","darkgray","gray","dimgray","black"])
...
# 绘制柱状图
g = sns.barplot(x=congnizaton1_read_type, y=filterd_read_ratio,ax=ax1,width=0.8,palette=["lightgray","silver","darkgray","gray","dimgray","black"])
ax1.tick_params(labelsize=20)
g.set_xlabel('Number of Useful Subreads',fontsize=20)
g.set_ylabel("Ratio",fontsize=20)
# 显示图形
...
subread_id = ["1","2","3","4","5","6","7","8","Overall"]
