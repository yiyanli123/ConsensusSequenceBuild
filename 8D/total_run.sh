...
help() {
    ...
    echo "    --hairpin1_seq  hairpin1 sequence.  : 第一段hairpin序列"
    echo "    --hairpin2_seq  hairpin2 sequence.  : 第二段hairpin序列"
    ...
    echo "    --poly_len  polyN length.  :hairpin1和hairpin2之间的poly长度."
...
echo "hairpin1_seq为:$hairpin1_seq"
echo "hairpin2_seq为:$hairpin2_seq"
echo "err_threshold为:$err_threshold"
echo "step_len为:$step_len"
echo "adjusted_len为:$adjusted_len"
echo "poly_len为:$poly_len"
echo "subread_len_filter_thre为:$subread_len_filter_thre"

startTime=`date +"%Y-%m-%d %H:%M:%S"`

#核心拆分程序
python main.py --fq_file $fq_file --res_dir $res_dir --hairpin1_seq $hairpin1_seq --hairpin2_seq $hairpin2_seq 
#1>log 2>err.log 
