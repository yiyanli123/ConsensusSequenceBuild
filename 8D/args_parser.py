...
def set_parser():
    ...
    parser.add_argument( '--hairpin1_seq', type=str, help='hairpin1 seq.')
    parser.add_argument( '--hairpin2_seq', type=str, help='hairpin2 seq.')
    ...
    parser.add_argument( '--poly_len', type=int,default=10,  help='gap len.')
